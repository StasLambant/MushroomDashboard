...
# Track the current relay state
relay_state = GPIO.HIGH  # Start with relay OFF (high)
...
def check_and_control_relay(humidifier_on, humidifier_off):
    ...
    """
    global relay_state  # Access the relay_state variable
    ...
    try:
        ...
        if humidity is not None:
            ...
            if humidity < humidifier_on and relay_state == GPIO.HIGH:
            ...
            elif humidity >= humidifier_off and relay_state == GPIO.LOW:
